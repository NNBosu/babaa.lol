...
<div class="form">
    ...
    <form method="post">
            ...
            <p>Email</p>
                <input type="email" minlength="10" maxlength="40" name="email" placeholder="Email" />
            <p>Password</p>
			...
			<p id="text" style="margin-left: -20px;">Already registered?<a href="index.php" id="signup_click">Login!</a></p>
